...
# Course Goals
By the end of the course, students wil be able to:

  * Use [GitHub](https://github.com/) for creating a reproducible research document.
      - My GitHub username is:*Joonsoo97*
...
The secound line of output is printed out instead, but this means that the calculated value has not been saved for future use.
